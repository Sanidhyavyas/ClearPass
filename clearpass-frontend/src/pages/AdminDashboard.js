...
function AdminDashboard() {
  ...
  const headerActions = (
    <button type="button" onClick={loadData} className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-ink2 hover:bg-raised hover:text-ink transition-all duration-150 text-sm" aria-label="Refresh dashboard data">
